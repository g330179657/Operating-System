...
public class UserKernel extends ThreadedKernel {
	...
	public void initialize(String[] args) {
		...
		this.pageLock = new Lock();
		//System.out.println(pageLock == null);
		this.freePhysPages = new LinkedList<Integer>();
		for(int i = 0; i < n; i++){
			freePhysPages.add(i);
		}
		//Collections.sort(freePhysPages, Collections.reverseOrder());
		System.out.println("Finish initialize freePhysPages and lock");
	}
	...
	// static freePhysPages lock
	public static Lock pageLock;

	// static linked list of free physical pages
